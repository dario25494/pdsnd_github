...
def station_stats(df):
    ...
    max_two=df['End Station'].value_counts().max()
    most_commonly_used_end_station = df['End Station'].value_counts()[df['End Station'].value_counts()==max_two].index[0]
    print('the most common used End Station is {} with a number of times of {}'.format(most_commonly_used_end_station, max_two))
